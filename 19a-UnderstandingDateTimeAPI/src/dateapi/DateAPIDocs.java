...
public class DateAPIDocs {
    /*
    Java Time API, is a comprehensive set of classes for handling dates, times, and durations.

    Introduced in Java 8, it provides a more powerful and flexible way to work with date and
    time compared to the old java.util.Date and java.util.Calendar classes.
    ...
    Instant: Represents a point in time (timestamp) from the epoch (1970-01-01T00:00:00Z).
