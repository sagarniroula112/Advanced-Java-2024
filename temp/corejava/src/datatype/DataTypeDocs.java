...
public class DataTypeDocs {
		 ...
		 * 
		 * Types of datatype
		 * 1. Primitive - byte, short, int(default), long, float(small fraction), double(large)(default), char, boolean
